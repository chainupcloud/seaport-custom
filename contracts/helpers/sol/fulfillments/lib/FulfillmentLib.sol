...
library FulfillmentGeneratorLib {
    ...
    function consumeRandomItemsAndGetFulfillment(
        ...
        uint256[] memory consumableOfferIndices = new uint256[](offerItems.items.length);
        uint256[] memory consumableConsiderationIndices = new uint256[](considerationItems.items.length);
        ...
        returns (FulfillmentComponent[][] memory, ItemCategory[] memory)
    {
        ...
        ItemCategory[] memory categories = new ItemCategory[](fulfillmentItems.length);
        ...
        returns (FulfillmentComponent[] memory)
    {
        ...
        FulfillmentComponent[] memory fulfillment = new FulfillmentComponent[](consumableItemIndices.length);
    ...
    function getFulfillmentComponents(FulfillmentItem[] memory items)
        ...
        returns (FulfillmentComponent[] memory)
    {
        FulfillmentComponent[] memory fulfillment = new FulfillmentComponent[](items.length);
...
library MatchableItemReferenceGroupLib {
    ...
    function getMatchDetails(MatchableItemReferenceGroup[] memory matchableGroups, address recipient)
        ...
        returns (MatchDetails memory)
    {
        DualFulfillmentItems[] memory items = new DualFulfillmentItems[](matchableGroups.length);
...
library HashAllocatorLib {
        ...
        returns (MatchableItemReferenceGroupLib.MatchableItemReferenceGroup[] memory)
    {
        MatchableItemReferenceGroupLib.MatchableItemReferenceGroup[] memory group =
            (new MatchableItemReferenceGroupLib.MatchableItemReferenceGroup[](hashCount.length));
...
library ItemReferenceLib {
    ...
    {
        ItemReference[] memory itemReferences = new ItemReference[](getTotalItems(orderDetails));
    ...
    function shuffle(ItemReference[] memory itemReferences, uint256 seed)
        ...
        returns (ItemReference[] memory)
    {
        ItemReference[] memory shuffledItemReferences = new ItemReference[](itemReferences.length);
