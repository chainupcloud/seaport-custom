...
import {ConsiderationItem, OfferItem, ReceivedItem, SpentItem} from "../../../lib/ConsiderationStructs.sol";
...
library ConsiderationItemLib {
    ...
    function copy(ConsiderationItem[] memory items) internal pure returns (ConsiderationItem[] memory) {
        ConsiderationItem[] memory copies = new ConsiderationItem[](items.length);
