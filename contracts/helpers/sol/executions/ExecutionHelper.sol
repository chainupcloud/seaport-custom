...
library ExecutionHelper {
    ...
    function getStandardExecutions(
        ...
        implicitExecutions = new Execution[](2 * orderDetails.offer.length + orderDetails.consideration.length + 2);
    ...
    function getBasicExecutions(
        ...
        if (orderDetails.offer[0].itemType == ItemType.ERC20) {
            ...
            implicitExecutions = new Execution[](1 + orderDetails.consideration.length);
            ...
            //  - returning unspent native tokens (0-1)
            implicitExecutions = new Execution[](orderDetails.consideration.length + 3);
    ...
    function processExplicitExecutionsFromAggregatedComponents(
        ...
        explicitExecutions = new Execution[](offerComponents.length + considerationComponents.length);
