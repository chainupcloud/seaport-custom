...
library IssueStringHelpers {
    ...
    function toString(ConsiderationIssue id) internal pure returns (string memory) {
        string memory code;
    ...
    function toString(PrimaryFeeIssue id) internal pure returns (string memory) {
        string memory code;
    ...
    function toString(CreatorFeeIssue id) internal pure returns (string memory) {
        string memory code;
    ...
    function toString(ContractOffererIssue id) internal pure returns (string memory) {
        string memory code;
    ...
    function toIssueString(uint16 issueCode) internal pure returns (string memory issueString) {
    ...
    function toIssueString(uint16[] memory issueCodes) internal pure returns (string memory issueString) {
        for (uint256 i; i < issueCodes.length; i++) {
            issueString = string.concat(issueString, "\n    ", toIssueString(issueCodes[i]));
        }
    }
}
